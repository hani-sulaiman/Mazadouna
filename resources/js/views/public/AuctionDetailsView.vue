<template>
    <main class="live-action">
        <div class="show-sction details" v-if="auctionDetails">
            ...
            <div class="image">
                <img :src="auctionDetails.thumbnail_image" alt="Auction Image">
            </div>
            ...
            <div class="info-car info-details">
                ...
                <p><span class="clr">Auction start date and time:</span> <span>{{ auctionDetails.start_date }}</span>
                </p>
                <p><span class="clr">Auction End Date and Time:</span> <span>{{ auctionDetails.end_date }}</span></p>
            </div>
            ...
            <div class="Opening-price details-Opening-price">
                Opening price: <p>₿ {{ auctionDetails.starting_price }}</p>
            </div>
            ...
            <div class="show-action-info"></div>
        </div>
    </main>
</template>
...
export default {
    ...
    async mounted() {
        ...
        this.incrementViewCount(auctionId)
