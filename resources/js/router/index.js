...
const routes = [
    {
        ...
        children: [
            ...
            { path: 'auction/live/:id', name: 'LiveAuction', component: LiveAuctionView ,meta:{requiresAuth:true} },
        ],
    },
    {
        path: '/user',
        ...
        children: [
            ...
            { path: 'manage-auctions', name: 'ManageAuctions', component: ManageAuctionsView },
            { path: 'favorites', name: 'Favorites', component: FavoritesView },
            { path: 'my-orders', name: 'UserOrders', component: ManageOrdersViewUser },
            { path: 'manage-auctions/create', name: 'CreateAuction', component: CreateNewAuction },
            { path: 'manage-auctions/edit/:id', name: 'EditAuction', component: EditAuction },
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'orders', name: 'ManageOrdersAdmin', component: ManageOrdersView },
        ],
    },
];
