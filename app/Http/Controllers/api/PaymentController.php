...
class PaymentController extends Controller
{
    ...
    public function generatePaymentLinks(Request $request)
    {
        ...
        // Check if the auction has an associated winner with a matching user_id
        ...
        // Check if an order already exists for this auction and winner
        ...
        // Proceed to create an order if it doesn't exist
        $order = Order::create([
        ...
        // Now proceed with the payment link generation as usual
        // Find the auction owner (receiver) and admin (receiver) users
        ...
        // Calculate the 10% and 90% amounts
        $adminAmount = $endedPrice * 0.10;
        $ownerAmount = $endedPrice * 0.90;
    
        // Set NOWPayments request parameters
        $currency = 'BTC';
        ...
        try {
            ...
            // Generate the payment link for the admin (10%)
            ...
            // Create transaction for admin payment
            $adminTransaction = Transaction::create([
                ...
                'status' => 'pending',
                'order_id' => $order->id, // Associate transaction with the order
                'date' => now(),
            ]);
    
            // Generate the payment link for the auction owner (90%)
            ...
            // Create transaction for owner payment
